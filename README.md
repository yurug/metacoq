...
The [documentation (coqdoc files)](html/Template.All.html)
...
The current development includes:
  ...
  - The full syntax of CIC:
    [Ast](https://github.com/MetaCoq/metacoq/blob/master/template-coq/theories/Ast.v)

  - The typing judgment of CIC: 
    [Typing](https://github.com/MetaCoq/metacoq/blob/master/template-coq/theories/Typing.v#L488)
    
  - A partial type-checker implementation:
    [Checker](https://github.com/MetaCoq/metacoq/blob/master/template-coq/theories/Checker.v)

  - The `TemplateMonad` datatype and the `Run TemplateProgram` command
    to run template programs:
    [TemplateMonad](https://github.com/MetaCoq/metacoq/blob/master/template-coq/theories/TemplateMonad.v)
        
Examples of plugins
-------------------
- a plugin to add a constructor in [test-suite/add_constructor.v](https://github.com/MetaCoq/metacoq/tree/master/test-suite/add_constructor.v)
- a parametricity plugin in [translations/tsl_param.v](https://github.com/MetaCoq/metacoq/tree/master/translations/tsl_param.v)
- a plugin to negate funext in [translations/fun.v](https://github.com/MetaCoq/metacoq/tree/master/translations/tsl_fun.v)
...
- The version of Coq corresponding to your branch
...
you don't have one yet:
    ...
    # opam switch -A 4.06.1 coq.8.9.0
